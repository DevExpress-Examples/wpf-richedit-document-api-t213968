...
'			#Region "#CreateBulletedList"
			...
			document.AppendText("Line 1" & Constants.vbLf & "Line 2" & Constants.vbLf & "Line 3")
...
'			#Region "#CreateNumberedList"
			...
			document.AppendText("Line one" & Constants.vbLf & "Line two" & Constants.vbLf & "Line three" & Constants.vbLf & "Line four")
