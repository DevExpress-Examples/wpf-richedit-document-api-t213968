...
Namespace DXRichEditControlAPISample.CodeExamples
	Public Module NotesActions
		...
		Private Sub InsertFootnotes(ByVal document As Document)
...
'			#End Region ' #InsertFootnotes 
		...
		Private Sub InsertEndnotes(ByVal document As Document)
...
'			#End Region ' #InsertEndnotes
		...
		Private Sub EditFootnote(ByVal document As Document)
'			#Region "#EditFootnote"
			document.LoadDocument("Documents//Grimm.docx")
...
'			#End Region ' #EditFootnote
		...
		Private Sub EditEndnote(ByVal document As Document)
'			#Region "#EditEndnote"
			document.LoadDocument("Documents//Grimm.docx")
...
'			#End Region ' #EditEndnote
		...
		Private Sub EditSeparator(ByVal document As Document)
...
'			#End Region ' #EditSeparator
		End Sub
		Private Sub RemoveNotes(ByVal document As Document)
'			#Region "#RemoveNotes"
			document.LoadDocument("Documents//Grimm.docx")
