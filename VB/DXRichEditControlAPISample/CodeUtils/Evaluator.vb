...
'INSTANT VB NOTE: The field codeStart was renamed since Visual Basic does not allow fields to have the same name as other class members:
		Private Const codeStart_Conflict As String = "using System;" & vbCrLf & "using DevExpress.XtraRichEdit;" & vbCrLf & "using DevExpress.XtraRichEdit.API.Native;" & vbCrLf & "using DevExpress.Xpf.RichEdit;" & vbCrLf & "using DevExpress.Office.Utils;" & vbCrLf & "using System.Drawing;" & vbCrLf & "using System.Windows;" & vbCrLf & "using DevExpress.Utils;" & vbCrLf & "using System.IO;" & vbCrLf & "using System.Diagnostics;" & vbCrLf & "using System.Xml;" & vbCrLf & "using System.Data;" & vbCrLf & "using System.Collections.Generic;" & vbCrLf & "using System.Linq;" & vbCrLf & "using System.Globalization;" & vbCrLf & "using System.Windows.Resources;" & vbCrLf & "namespace RichEditCodeResultViewer { " & vbCrLf & "public class ExampleItem { " & vbCrLf & "        public static void Process(Document document) { " & vbCrLf & vbCrLf
...
'INSTANT VB NOTE: The field codeEnd was renamed since Visual Basic does not allow fields to have the same name as other class members:
	...
	Public Class RichEditVbExampleCodeEvaluator
		...
		End Function
'INSTANT VB NOTE: The field codeStart was renamed since Visual Basic does not allow fields to have the same name as other class members:
		Private Const codeStart_Conflict As String = "Imports Microsoft.VisualBasic" & vbCrLf & "Imports System" & vbCrLf & "Imports DevExpress.XtraRichEdit" & vbCrLf & "Imports DevExpress.XtraRichEdit.API.Native" & vbCrLf & "Imports System.Drawing" & vbCrLf & "Imports DevExpress.Office.Utils" & vbCrLf & "Imports System.Windows" & vbCrLf & "Imports DevExpress.Utils" & vbCrLf & "Imports System.IO" & vbCrLf & "Imports System.Diagnostics" & vbCrLf & "Imports System.Xml" & vbCrLf & "Imports System.Data" & vbCrLf & "Imports System.Collections.Generic" & vbCrLf & "Imports System.Globalization" & vbCrLf & "Imports System.Windows.Resources" & vbCrLf & "Namespace RichEditCodeResultViewer" & vbCrLf & "	Public Class ExampleItem" & vbCrLf & "		Public Shared Sub Process(ByVal document As Document)" & vbCrLf & vbCrLf
